...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net net_slot_1_axi_ar_ctrl [get_bd_pins ila_lib/probe26] [get_bd_pins slot_1_ar/dout]
  ...
  connect_bd_net -net net_slot_1_axi_aw_ctrl [get_bd_pins ila_lib/probe23] [get_bd_pins slot_1_aw/dout]
  ...
  connect_bd_net -net net_slot_1_axi_b_ctrl [get_bd_pins ila_lib/probe25] [get_bd_pins slot_1_b/dout]
  connect_bd_net -net net_slot_1_axi_bready [get_bd_pins g_inst/m_slot_1_axi_bready] [get_bd_pins slot_1_b/In1]
  connect_bd_net -net net_slot_1_axi_bresp [get_bd_pins g_inst/m_slot_1_axi_bresp] [get_bd_pins ila_lib/probe18]
  connect_bd_net -net net_slot_1_axi_bvalid [get_bd_pins g_inst/m_slot_1_axi_bvalid] [get_bd_pins slot_1_b/In0]
  connect_bd_net -net net_slot_1_axi_r_cnt [get_bd_pins g_inst/m_slot_1_axi_r_cnt] [get_bd_pins ila_lib/probe19]
  connect_bd_net -net net_slot_1_axi_r_ctrl [get_bd_pins ila_lib/probe27] [get_bd_pins slot_1_r/dout]
  connect_bd_net -net net_slot_1_axi_rdata [get_bd_pins g_inst/m_slot_1_axi_rdata] [get_bd_pins ila_lib/probe20]
  ...
  connect_bd_net -net net_slot_1_axi_w_ctrl [get_bd_pins ila_lib/probe24] [get_bd_pins slot_1_w/dout]
  ...
  connect_bd_net -net net_slot_1_axi_wstrb [get_bd_pins g_inst/m_slot_1_axi_wstrb] [get_bd_pins ila_lib/probe22]
