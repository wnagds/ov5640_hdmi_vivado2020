...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SLOT_0_VID_IO_active_video_1 [get_bd_ports SLOT_0_VID_IO_active_video] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_VID_IO_data_1 [get_bd_ports SLOT_0_VID_IO_data] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_VID_IO_vsync_1 [get_bd_ports SLOT_0_VID_IO_vsync] [get_bd_pins ila_lib/probe0]
