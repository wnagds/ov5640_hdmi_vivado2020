...
module system_wrapper
  ...
  wire cam_rst_n;
  wire cam_vsync;
  wire [0:0]sccb_tri_i_0;
  wire [1:1]sccb_tri_i_1;
  wire [0:0]sccb_tri_io_0;
  wire [1:1]sccb_tri_io_1;
  wire [0:0]sccb_tri_o_0;
  wire [1:1]sccb_tri_o_1;
  wire [0:0]sccb_tri_t_0;
  wire [1:1]sccb_tri_t_1;
  wire tmds_oen;

  IOBUF sccb_tri_iobuf_0
       (.I(sccb_tri_o_0),
        .IO(sccb_tri_io[0]),
        .O(sccb_tri_i_0),
        .T(sccb_tri_t_0));
  IOBUF sccb_tri_iobuf_1
       (.I(sccb_tri_o_1),
        .IO(sccb_tri_io[1]),
        .O(sccb_tri_i_1),
        .T(sccb_tri_t_1));
  system system_i
       (.DDR_addr(DDR_addr),
        ...
        .cam_rst_n(cam_rst_n),
        .cam_vsync(cam_vsync),
        .sccb_tri_i({sccb_tri_i_1,sccb_tri_i_0}),
        .sccb_tri_o({sccb_tri_o_1,sccb_tri_o_0}),
        .sccb_tri_t({sccb_tri_t_1,sccb_tri_t_0}),
        .tmds_oen(tmds_oen));
endmodule
