...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8422.protoinst" -protoinst "protoinst_files/bd_1519.protoinst" -protoinst "protoinst_files/bd_1579.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
