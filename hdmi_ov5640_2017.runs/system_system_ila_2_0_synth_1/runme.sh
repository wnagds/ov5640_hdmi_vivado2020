...
HD_PWD='C:/Users/wnagds/Desktop/hdmi_ov5640_2017/hdmi_ov5640_2017.runs/system_system_ila_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_system_ila_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_system_ila_2_0.tcl
