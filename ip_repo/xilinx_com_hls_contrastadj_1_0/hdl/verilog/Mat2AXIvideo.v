...
reg   [0:0] ap_reg_pp0_iter1_exitcond_reg_266;
reg   [10:0] t_V_1_reg_184;
wire   [0:0] exitcond1_fu_200_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [10:0] i_V_fu_206_p2;
reg   [10:0] i_V_reg_261;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_212_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((ap_reg_pp0_iter1_exitcond_reg_266 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_reg_266 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        dst_axi_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
...
always @ (*) begin
    if (((exitcond_reg_266 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_fu_212_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond_fu_212_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign AXI_video_strm_V_data_V_1_ack_out = dst_axi_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = dst_axi_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = dst_axi_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = dst_axi_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = dst_axi_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = dst_axi_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = dst_axi_TREADY;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_266 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_266 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_266 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_io = ((exitcond_reg_266 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_266 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_reg_266 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_266 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state5_io = ((ap_reg_pp0_iter1_exitcond_reg_266 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign axi_last_V_fu_224_p2 = ((t_V_1_reg_184 == 11'd1919) ? 1'b1 : 1'b0);

assign dst_axi_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign dst_axi_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign dst_axi_TID = AXI_video_strm_V_id_V_1_data_out;

assign dst_axi_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign dst_axi_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign dst_axi_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign dst_axi_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign dst_axi_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];

assign exitcond1_fu_200_p2 = ((t_V_reg_173 == 11'd1080) ? 1'b1 : 1'b0);

assign exitcond_fu_212_p2 = ((t_V_1_reg_184 == 11'd1920) ? 1'b1 : 1'b0);

assign i_V_fu_206_p2 = (t_V_reg_173 + 11'd1);

assign j_V_fu_218_p2 = (t_V_1_reg_184 + 11'd1);

assign tmp_data_V_fu_234_p4 = {{{img_data_stream_2_V_dout}, {img_data_stream_1_V_dout}}, {img_data_stream_0_V_dout}};
